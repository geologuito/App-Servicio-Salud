...
public class SeguridadWeb extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.authorizeRequests()
                ...
                .and().csrf()
                        .disable();
<<<<<<< HEAD:servicioSalud/src/main/java/com/app/servicioSalud/SeguridadPaciente.java
    }*/
   @Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true)
...
>>>>>>> developer:servicioSalud/src/main/java/com/app/servicioSalud/SeguridadWeb.java
    }
